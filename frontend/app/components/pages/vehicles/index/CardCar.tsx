...
export default async function CardCars()
{
    return(
        ...
        <Link href={`/pages/vehicles/1`}  className="w-[calc(100%-(.75rem*2))] p-4 bg-blue-400 text-white rounded-lg mb-3 text-center font-semibold uppercase tracking-widest">Alugar veículo</Link>
      </div>
    )
}